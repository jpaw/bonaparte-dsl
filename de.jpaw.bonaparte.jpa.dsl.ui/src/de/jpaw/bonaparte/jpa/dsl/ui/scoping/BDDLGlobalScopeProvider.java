package de.jpaw.bonaparte.jpa.dsl.ui.scoping;
...
public class BDDLGlobalScopeProvider extends TypesAwareDefaultGlobalScopeProvider {

    Logger LOG = Logger.getLogger(BDDLGlobalScopeProvider.class);
...
//          return result;
        ...
        LOG.error("Couldn't find resource contained in current java project '"+project.getElementName()+"' for BDDL. Resource was "+resource.getURI());
