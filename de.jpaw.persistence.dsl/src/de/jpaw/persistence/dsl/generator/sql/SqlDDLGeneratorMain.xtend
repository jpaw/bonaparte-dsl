...
class SqlDDLGeneratorMain implements IGenerator {
    ...
    def sqlDdlOut(EntityDefinition t, DatabaseFlavour databaseFlavour, boolean doHistory) {
        ...
        CREATE TABLE «tablename» (
            ...
            «ENDIF»
            «baseEntity.tenantClass?.recurseColumns(null, databaseFlavour, d, baseEntity.pk?.columnName, theEmbeddables)»
            «IF t.discname != null»
        ...
        «IF databaseFlavour != DatabaseFlavour.MSSQLSERVER»
            ...
            «ENDIF»
            «baseEntity.tenantClass?.recurseComments(null, tablename, theEmbeddables)»
            «IF t.discname != null»
