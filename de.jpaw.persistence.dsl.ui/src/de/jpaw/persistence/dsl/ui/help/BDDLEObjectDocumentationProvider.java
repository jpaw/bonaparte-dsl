package de.jpaw.persistence.dsl.ui.help;
...
import de.jpaw.persistence.dsl.bDDL.OneToOne;
...
public class BDDLEObjectDocumentationProvider implements IEObjectDocumentationProvider {
    ...
    private static final String URL_PART = "http://docs.oracle.com/javaee/6/api/javax/persistence/";
