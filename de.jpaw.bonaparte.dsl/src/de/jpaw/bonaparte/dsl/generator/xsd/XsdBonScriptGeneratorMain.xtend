...
class XsdBonScriptGeneratorMain implements IGenerator {
    ...
    public static boolean GENERATE_EXTENSION_FIELDS = false;             // if true, xsd:anyType fields will be generated in order to support future optional extensions (currently only possible for final classes)
    public static boolean GENERATE_XSD_BY_DEFAULT = true;                // if true, also generate xsds if the class or package does not explicitly specify it 
    public static boolean SUBFOLDERS_FOR_BUNDLES = false;                // if true, also generate xsds if the class or package does not explicitly specify it 
